...
@section('content')
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter Tutteur</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Ajouter Tutteur</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                        <div class="col-sm">
                            <form class="needs-validation" method="POST" action="{{ url('tutteur') }}" novalidate>
                                {{ csrf_field() }}
                                <div class="form-row">
                                    <div class="col-md-4 mb-10">
                                        <label for="validationCustom01">Nom</label>
                                        <input type="text" class="form-control  @error('nom') is-invalid @enderror" id="validationCustom01" placeholder="Nom" name="nom"  required>
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" class="form-control  @error('prenom') is-invalid @enderror" id="validationCustom01" placeholder="Prenom" name="prenom"  required>
                                        <div class="invalid-feedback">
                                            Champ obligatoire
                                        </div>
                                        @error('prenom')
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="text" class="form-control  @error('adresse') is-invalid @enderror" id="validationCustom01" placeholder="Adresse" name="adresse"  required>
                                        <div class="invalid-feedback">
                                            Champ obligatoire
                                        </div>
                                        @error('adresse')
