        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <div class="col-sm">
                        <form class="needs-validation" method="POST" action="{{ URL('anneescolaire/'.$anneeScolaire->id) }}" novalidate>
                           @method('PUT')
                            {{ csrf_field() }}
                            <div class="form-row">
                                <div class="col-md-4 mb-10">
                                    <label for="validationCustom01">Année Scolaire</label>
                                    <input type="text" class="form-control" id="validationCustom01" value="{{$anneeScolaire->annee}}" name="annee" placeholder="ex: 2019-2020"  required>
