...
@section('content')
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter paiement</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                        <div class="col-sm">
                            <form class="needs-validation" method="POST" action="{{ url('paiement') }}" novalidate>
                                {{ csrf_field() }}
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <input type="number" class="form-control" id="validationCustom01" name="montant"   required>
                                    ...
                                    <div class="col-md-4 mb-10">
                                        <label for="validationCustom01">Matière</label>
                                            ...
                                            @foreach($mois as $moi)
                                                <option value="{{  $moi->id }}">{{  $moi->nom }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <select class="form-control select2" name="inscription_id" required>
                                            ...
                                            @foreach($inscriptions as $inscription)
                                                <option value="{{  $inscription->id }}"> {{  $inscription->eleve->prenom }}  {{  $inscription->eleve->nom }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-tooltip">Champs obligatoire</div>
                                    </div>
