...
@section('content')
    <nav class="hk-breadcrumb" aria-label="breadcrumb">
        <ol class="breadcrumb breadcrumb-light bg-transparent">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter Evaluation</li>
        </ol>
    </nav>
    <!-- /Breadcrumb -->
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="external-link"></i></span></span>Ajouter evaluation</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                        <div class="col-sm">
                            <form class="needs-validation" method="POST" action="{{ url('evaluation') }}" novalidate>
                                {{ csrf_field() }}
                                    ...
                                    <div class="col-md-4 mb-10">
                                        ...
                                        <select class="form-control select2" name="type_evaluation_id" required>
                                            ...
                                            @foreach($typeEvaluations as $typeEvaluation)
                                                <option value="{{  $typeEvaluation->id }}"> {{  $typeEvaluation->nom }}</option>
                                            @endforeach
                                        </select>
                                        <div class="invalid-tooltip">Champs obligatoire</div>
                                    </div>
