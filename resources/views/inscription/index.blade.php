...
@section('content')
    ...
    <div class="container">
        ...
        <div class="hk-pg-header">
            <h4 class="hk-pg-title"><span class="pg-title-icon"><span class="feather-icon"><i data-feather="database"></i></span></span>Liste des classes</h4>
        </div>
        <!-- /Title -->
        ...
        <div class="row">
            <div class="col-xl-12">
                <section class="hk-sec-wrapper">
                    <h5 class="hk-sec-title">Liste des classes</h5>
                    <div class="row">
                        <div class="col-sm">
                            <div class="table-wrap">
                                <table id="datable_1" class="table table-hover w-100 display pb-30">
                                    ...
                                    @foreach($classes as $classe)
                                        <tr>
                                            <td>{{ $classe->nom }}</td>
                                            <td> @if($classe->serie) {{$classe->serie->nom}} @endif</td>
                                            <td>{{$classe->anneeScolaire->annee}}</td>
                                            <td>{{$classe->niveau->nom}}</td>
                                            <td> @if($classe->tarif) Inscription :{{  $classe->tarif->inscription }}, Mensuel: {{ $classe->tarif->mensualite }} @endif</td>
